...
namespace cAlgo
{
    ...
    public class SampleMartingalecBot : Robot
    {
        ...
        [Parameter("Max Win in Row", DefaultValue = 3)]
        public int maxWinInRow { get; set; }
        ...
        private void ExecuteOrder(double quantity, TradeType tradeType)
        {
            ...
            var result = ExecuteMarketOrder(tradeType, Symbol, volumeInUnits, "InvertedMartingale", StopLoss, TakeProfit);
        ...
        private void OnPositionsClosed(PositionClosedEventArgs args)
        {
            ...
            if (position.Label != "InvertedMartingale" || position.SymbolCode != Symbol.Code)
                return;
